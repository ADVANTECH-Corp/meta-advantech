...
SRC_URI = "file://gobinet.tar.gz"
SRCPV = "S2.31N2.50"
PV = "${SRCPV}"

S = "${WORKDIR}/gobinet/"

EXTRA_OEMAKE += "KDIR='${STAGING_KERNEL_DIR}' OUTPUTDIR='${D}/lib/modules/${KERNEL_VERSION}/kernel/drivers/net/usb/'"
MAKE_TARGETS = "all"
